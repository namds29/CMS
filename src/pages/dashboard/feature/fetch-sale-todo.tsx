...
import { useFetchSaleTodos } from "../../../shared/hooks/useFetchSaleTodo";
...
const FetchSaleTodo: FC<Props> = ({}) => {
  ...
  return (
    <div>
      ...
      Danh sách khách hàng cần gọi trong ngày
      </p>
      <Table
        columns={columns}
        dataSource={listSaleTodo}
        scroll={{ x: 1500 }}
        // sticky
      />
